                    ...
                    <div class="card">
                        <div class="card-body">
                                ...
                                <div class="col-12 col-lg-9 col-md-12 d-flex align-items-center justify-content-end flex-wrap col-filter"> 
                                    ...
                                    <div class="datatable-export">
                                        <div class="datatable-print admin">
                                            <a href="">
                                                <img src="/assets/images/svg/print-report-icon.svg" alt="" class="position-absolute admin_print" id="admin-roles-print-icon">
                                            </a>
                                        </div>
                                        <div class="datatable-report admin position-relative">
                                            <a href="">
                                                <img src="/assets/images/svg/export-report-icon.svg" alt="" class="position-absolute admin-report" id="admin-roles-report-icon">
                                            </a>
                            ...
                            <div class="data-tables table-responsive">
                                ...
                                <table id="backend_roles" class="text-center datatable-dark backend_datatables table-opacity">
                                    <thead class="text-capitalize">
                                        <tr>
                                            <th width="5%">
                                                {{ config('constants.label.admin.sl') }}
                                                <span data-col='id' data-table='roles' data-ordertype='asc' class="asc">&#x2191;</span>
                                                <span data-col='id' data-table='roles' data-ordertype='desc' class="desc">&#x2193;</span>
                                            </th>
                                            <th width="10%">
                                                Name
                                                <span data-col='name' data-table='roles' data-ordertype='asc' class="asc">&#x2191;</span>
                                                <span data-col='name' data-table='roles' data-ordertype='desc' class="desc">&#x2193;</span>
                                            </th>
                                            <th width="60%">
                                                Permissions
                                            </th>
