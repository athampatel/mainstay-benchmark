        ...
        $.ajax({
            ...
            success: function (res) {
                ...
                if(total_records > 1){
                    ...
                    var row_html = '';//'<form action="/customers" method="POST" id="create-multiple">';
