            ...
            <nav class="topbar-nav">
                <ul class="metismenu" id="menu">
                    <li>
                        ...
                        <ul>
                            <li><a href="{{ url('index') }}"><i class="bx bx-right-arrow-alt"></i>Analytics</a></li>
                            <li><a href="{{ url('sales') }}"><i class="bx bx-right-arrow-alt"></i>Sales</a></li>
                            <li><a href="{{ url('ecommerce') }}"><i class="bx bx-right-arrow-alt"></i>eCommerce</a></li>
                            <li><a href="{{ url('alternate') }}"><i class="bx bx-right-arrow-alt"></i>Alternate</a></li>
                            <li><a href="{{ url('hospitality') }}"><i class="bx bx-right-arrow-alt"></i>Hospitality</a></li>
                        </ul>
                    </li>
                    <li>
                        <a href="javascript:;" class="has-arrow">
