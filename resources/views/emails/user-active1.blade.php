                    ...
                    <tr>
                        <td>
                            <table border="0" width="300" align="left" cellpadding="0" cellspacing="0" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" class="container590">
                                ...
                                <tr>
                                    <!-- logo -->
                                    Lorem ipsum dolor sit amet, consectetur adipisicing elit. Asperiores, eum molestiae! Est ipsam impedit ex reiciendis molestias fugit libero enim fuga aut nisi tempore suscipit iste dolorem id obcaecati amet veritatis vero, illum sapiente similique soluta! Quos rerum corporis id soluta vero odio. Sit velit illo inventore, omnis enim, quae commodi mollitia, fuga molestias quis iste eaque error expedita natus cumque. Perspiciatis beatae nemo eum. Reprehenderit, odit voluptas. Pariatur placeat nulla accusamus iste magni ea deserunt voluptas eos et sunt unde aperiam, nesciunt tempore sapiente facilis error obcaecati explicabo ducimus exercitationem eius consectetur iure totam. Aspernatur, ipsum. Explicabo, error voluptatem.

                                    url: 

                                    {{ asset('/assets/images/login-images/forgot-password-frent-img.jpg') }}
                                    *****
                                    <td align="left">
                                        <a href="" style="display: block; border-style: none !important; border: 0 !important;">
                                            {{-- <img src="{{ asset('/assets/images/login-images/forgot-password-frent-img.jpg') }}" alt="Forgot Password Image" style="display:block; margin-left: auto; margin-right: auto;" width="200" height="200" data-auto-embed="attachment"> --}}
										{{-- <img src="/images/GEPRECISIONHEALTHCARELLC_20230130_123341.jpg" width="150" alt="" /> --}}
										<img src="https://picsum.photos/300/300" alt="" />
										{{-- <img src="/assets/images/login-images/forgot-password-frent-img.jpg" alt="Forgot Password Image"> --}}
										{{-- <img src="{{ asset('/assets/images/login-images/forgot-password-frent-img.jpg') }}" alt="Forgot Password Image" style="display:block; margin-left: auto; margin-right: auto;" width="200" height="200" data-auto-embed="attachment"> --}}
										{{-- <img src="{{ asset('/assets/images/login-images/forgot-password-frent-img.jpg') }}" alt="Forgot Password Image" style="display:block; margin-left: auto; margin-right: auto;" width="200" height="200" data-auto-embed="attachment"> --}}
										{{-- <img src="{{ asset('images/bg-themes/1.png') }}"> --}}
                                        {{-- <img src="/assets/images/bg-themes/1.png" width="150" alt="" /> --}}
										{{-- <img src="/assets/images/logo.svg" width="150" alt="" /> --}}
                                    </td>
                                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptatibus veniam id ex nisi doloremque provident sequi consequatur quibusdam soluta officiis!
                                </tr>
                                ...
                                <tr>
                                    <td align="left" style="color: #888888; font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 23px;" class="text_color">
                                        <div style="color: #333333; font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; font-weight: 600; mso-line-height-rule: exactly; line-height: 23px;">
                                            ...
                                            Email us: <br/> <a href="mailto:" style="color: #888888; font-size: 14px; font-family: 'Hind Siliguri', Calibri, Sans-serif; font-weight: 400;">orders@benchmarkproducts.com</a>
                                ...
                                <tr>
                                    <td align="left" style="color: #aaaaaa; font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 24px;">
                                        <div style="line-height: 24px;">
                                            ...
                                            <span style="color: #333333;">&copy; Benchmark Products</span>
