							...
							<div class="p-4 rounded">
								...
								<div class="form-body">
									...
									@elseif(Session::has('status'))
										<div class="text-center py-4">
											<p class="login-from-title font-open-sans font-bold font-20 text-success">{{ Session::get('status')}}</p>									
										</div>									
									@elseif(!Session::has('status'))
									<div class="text-center py-4">
										<p class="font-open-sans font-bold font-20 text-danger">Password reset link is expired or invalid.</p>									
									</div>
